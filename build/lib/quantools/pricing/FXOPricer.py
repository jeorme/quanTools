...
#                                   timeToSettle,windowBarrierType,Barrier1Level,Barrier1Rebate,Barrier1Direction,Barrier1Activation,barrier1StartDate,barrier1EndDate,
#                                   Barrier2Level,Barrier2Rebate,Barrier2Direction,Barrier2Activation,barrier2StartDate,barrier2EndDate, computePrimeOnly,hideTraces):
#     if windowBarrierType == "SingleEarlyEnding":
#          return priceSingleEarlyEnding(ForeignRate,DomesticRate,fixedAmount, optionType,cashPercent,PaymentAt,volatility,Spot,Strike,Time,
#                                   timeToSettle,Barrier1Level,Barrier1Rebate,Barrier1Direction,Barrier1Activation, barrier1StartDate,barrier1EndDate, computePrimeOnly,hideTraces)
#
#
#     return 0
#
# def priceSingleEarlyEnding(ForeignRate,DomesticRate,fixedAmount, optionType,cashPercent,PaymentAt,volatility,Spot,Strike,Time,
#                                   timeToSettle,Barrier1Level,Barrier1Rebate,Barrier1Direction,Barrier1Activaition, barrier1StartDate,barrier1EndDate, computePrimeOnly,hideTraces):
#      barrierDate = barrier1EndDate
#
#      if (barrierDate == timeToSettle):
...
#      d1 = (math.log(fwd / strike) + 0.5 * stdDev * stdDev) / stdDev
#      d2 = d1 - stdDev
#
#      f1 = getF1(d1, spot, level, stdDev)
#      f2 = f1 - stdDev
#
#      e1 = (math.log(wFwd / level) + 0.5 * stdDev * stdDev) / stdDev
#      e2 = e1 - wStdDev
#
